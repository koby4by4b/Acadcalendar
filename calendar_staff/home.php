...
<head>
    ...
    <title>Acadcalendar - Staff</title>
...
<body>
    ...
    <script>
    var init = function() {
          var alertedStaff = localStorage.getItem('alertedStaff') || '';
          if (alertedStaff != 'yes') {
              alert("Welcome to Acadcalendar - Scheduling Staff!");
              localStorage.setItem('alertedStaff','yes');
          }
          else{
             //Welcome Again
            alert("Welcome Back - Scheduling Staff!");
          }
      }
    setTimeout(function(){
      $(document).ready(init);
