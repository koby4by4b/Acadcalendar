...
<head>
    ...
    <title>Acadcalendar - Student</title>
...
<body>
    ...
    <script>
    var init = function() {
          var alertedStudent = localStorage.getItem('alertedStudent') || '';
          if (alertedStudent != 'yes') {
              alert("Welcome to Acadcalendar - Student!");
              localStorage.setItem('alertedStudent','yes');
          }
          else{
             //Welcome Again
