...
<head>
    ...
    <title>Acadcalendar - Admin Calendar</title>
...
<body>
                            ...
                            <div class="container-fluid">
                                <form action="save_event.php" method="post" id="schedule-form">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm rounded-0" name="course" id="course" placeholder="5-Announcement" required>
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="year" class="control-label">Year Code</label>
                                        <input type="text" class="form-control form-control-sm rounded-0" name="year" id="year" placeholder="5-Announcement" required>
                                    </div>
                                    <div class="form-group mb-2">
    ...
    <!-- Display Events -->
    <?php 
        $schedules = $conn->query("SELECT * FROM `acad_admin_events`");
        $sched_res = [];
    ...
    <script src="http://acadcalendar.42web.io/assets/js/admin_calendar.js"></script>
