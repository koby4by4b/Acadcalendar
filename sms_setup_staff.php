...
<body>
      ...
      <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
          <!-- .navbar -->
          <a href="http://acadcalendar.42web.io/calendar_staff/home.php" class="logo d-flex align-items-center">
            <img src="http://acadcalendar.42web.io/assets/img/logo.png" alt="">
            <span>Acadcalendar</span>
          </a>
          <nav id="navbar" class="navbar">
            <ul>
              <li><a class="nav-link scrollto active" href="http://acadcalendar.42web.io/calendar_staff/calendar/event_calendar.php">Calendar</a></li>
              <li><a class="nav-link scrollto" href="http://acadcalendar.42web.io/calendar_staff/staff_logout.php">Logout</a></li>
            </ul>
