...
$stmt1 = $conn->prepare('SELECT title, description, start_datetime, end_datetime FROM acad_student_events WHERE id = ?');
// Use ID to get info
...
<body>
      ...
      <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
          <!-- .navbar -->
          <a href="http://acadcalendar.42web.io/calendar_student/home.php" class="logo d-flex align-items-center">
            <img src="http://acadcalendar.42web.io/assets/img/logo.png" alt="">
            <span>Acadcalendar</span>
          </a>
          <nav id="navbar" class="navbar">
            <ul>
              <li><a class="nav-link scrollto active" href="http://acadcalendar.42web.io/calendar_student/calendar/event_calendar.php">Calendar</a></li>
              <li><a class="nav-link scrollto" href="http://acadcalendar.42web.io/calendar_student/student_logout.php">Logout</a></li>
            </ul>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea rows="5" class="form-control" placeholder="Enter message" required name="message" id="message">
                            <?php
                                $check = mysqli_query($conn,"SELECT title, description, start_datetime, end_datetime FROM acad_student_events ORDER BY id DESC LIMIT 1");
